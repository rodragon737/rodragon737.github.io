...
function Ue(e) {
  const t = e.split("/");
  return t.length === 3 && (!E[`${t[0]}`] || !E[`${t[0]}`][`${t[1]}`] || !E[`${t[0]}`][`${t[1]}`][`${t[2]}`]) || t.length === 2 && (!E[`${t[0]}`] || !E[`${t[0]}`][`${t[1]}`]) || t.length === 1 && !E[`${t[0]}`] ? (console.error("Given timezone not valid."), "") : t.length === 3 ? [
    E[`${t[0]}`][`${t[1]}`][`${t[2]}`][0],
    re(
      ie[E[`${t[0]}`][`${t[1]}`][`${t[2]}`][1]]
    )
...
function se(e, t, a) {
  ...
  const o = t + "T" + a + ":00", i = new Date(o), r = i.getFullYear(), l = i.getMonth() + 1, c = i.getDate(), d = i.getHours(), h = n[1].replace(/[^\w_\-:,;=+/<br>]/g, "").split("<br>"), b = { 1: {}, 2: {} };
  let s = 0;
  for (let x = 0; x < h.length; x++)
    if (h[`${x}`].startsWith("TZOFFSETTO") && (s++, b[`${s}`].offset = h[`${x}`].split(":")[1]), h[`${x}`].startsWith("DTSTART") && (b[`${s}`].hour = parseInt(h[`${x}`].substr(17, 2))), h[`${x}`].startsWith("RRULE")) {
      let w = h[`${x}`].split(";"), S = parseInt(w[1].split("=")[1]);
      b[`${s}`].month = parseInt(S), b[`${s}`].day = w[2].split("=")[1];
    }
  if (b[1].month > b[2].month && ([b[1], b[2]] = [b[2], b[1]]), l != b[1].month && l != b[2].month)
    return l < b[1].month || l > b[2].month ? b[2].offset : b[1].offset;
  const m = function() {
    return Object.keys(b).find((x) => b[`${x}`].month == l);
  }(), T = ["SU", "MO", "TU", "WE", "TH", "FR", "SA"], v = new Date(r, l, 0).getDate();
  let u = new Date(r, l - 1, 1).getDay();
  const y = { SU: {}, MO: {}, TU: {}, WE: {}, TH: {}, FR: {}, SA: {} };
  for (let x = 1; x <= v; x++) {
    const w = Object.keys(y[T[`${u}`]]).length + 1;
    y[T[`${u}`]][`${w}`] = x, u++, u == 7 && (u = 0);
  }
  const g = function() {
    if (b[`${m}`].day[0] == "-") {
      const x = b[`${m}`].day.substr(2, 2), w = Object.keys(y[`${x}`]).length + 1 - parseInt(b[`${m}`].day[1]);
      return y[`${x}`][`${w}`];
    } else {
      const x = b[`${m}`].day.substr(1, 2);
      return y[`${x}`][b[`${m}`].day[0]];
    }
  }();
  if (c > g || c == g && d >= b[`${m}`].hour)
    return b[`${m}`].offset;
  const f = function() {
    return m == 1 ? 2 : 1;
  }();
...
const Oe = "2.2.10", we = {
...
}, M = () => !(typeof window > "u"), C = M() ? () => !!(/iPad|iPhone|iPod/i.test(navigator.userAgent || navigator.vendor || window.opera) && !window.MSStream || navigator.platform === "MacIntel" && navigator.maxTouchPoints > 1) : () => !1, He = M() ? () => !!(/android/i.test(navigator.userAgent || navigator.vendor || window.opera) && !window.MSStream) : () => !1, Ne = M() ? () => !!/chrome|chromium|crios|google inc/i.test(navigator.userAgent || navigator.vendor) : () => !1, N = () => !!(He() || C()), de = M() ? () => !!/(; ?wv|(iPhone|iPod|iPad).*AppleWebKit(?!.*Safari))/i.test(navigator.userAgent || navigator.vendor) : () => !1, Ve = M() ? () => !!/(Instagram)/i.test(navigator.userAgent || navigator.vendor || window.opera) : () => !1, xe = de() ? "_system" : "_blank", We = ["apple", "google", "ical", "ms365", "outlookcom", "msteams", "yahoo"], Je = ["apple", "google", "ical"], Xe = ["msteams"], et = ["ical"], k = [], be = [
  "debug",
  "name",
  "dates",
  "description",
  ...
  "disabled",
  "hidden"
], tt = ["customLabels", "ty", "rsvp"], at = ["dates"], nt = ["images", "options"], $ = {
...
function ot(e) {
  return e = it(e), e = rt(e), e = lt(e), e = ct(e), e.sizes = st(e.size), e.lightMode = dt(e.lightMode), e = bt(e), e = ut(e), e = mt(e), e = gt(e), e = ht(e), e;
}
function it(e) {
  for (let t = 0; t < ue.length; t++) {
    const a = ue[`${t}`];
    e[`${a}`] != null && (e[`${a}`] === "true" || e[`${a}`] === !0) ? e[`${a}`] = !0 : e[`${a}`] = !1;
  }
  return e;
}
function rt(e) {
...
function lt(e) {
  ...
  for (let o = 0; o < e.options.length; o++) {
    const i = e.options[`${o}`].split("|"), r = i[0].toLowerCase().replace("microsoft", "ms").replace(/\./, ""), l = function() {
      return i[1] != null ? i[1] : "";
    }();
    r === "apple" && (n = !0), r === "ical" && (a = !0), !(C() && et.includes(r) || e.recurrence != null && e.recurrence != "" && (!Je.includes(r) || e.recurrence_until != null && e.recurrence_until != "" && (r == "apple" || r == "ical")) || e.subscribe && Xe.includes(r)) && (t.push(r), e.optionLabels.push(l));
  }
  return C() && a && !n && t.push("apple"), e.options = t, e;
}
function ct(e) {
...
function dt(e = "") {
  return e == "system" && M() ? window.matchMedia("(prefers-color-scheme: dark)").matches ? "dark" : "light" : e != "bodyScheme" && e != "dark" ? "light" : e;
}
function bt(e) {
  return (e.language == null || e.language == "" || !Wt.includes(e.language)) && (e.language = "en"), e.language.length > 2 && (e.language = e.language.substring(0, 2)), Vt.includes(e.language) ? e.rtl = !0 : e.rtl = !1, e;
}
function ut(e) {
  if (e.dates != null && e.dates.length > 0)
    for (let a = 0; a < e.dates.length; a++) {
      e.dates[`${a}`].timeZone == null && e.timeZone != null && (e.dates[`${a}`].timeZone = e.timeZone);
      const n = Te(e.dates[`${a}`]);
      e.dates[`${a}`].startTime = n.startTime, e.dates[`${a}`].endTime = n.endTime, e.dates[`${a}`].timeZone = n.timeZone, e.dates[`${a}`].startDate = G(n.startDate), e.dates[`${a}`].endDate = G(n.endDate), e.dates[`${a}`].timestamp = le("timestamp", e.dates[`${a}`].startDate, e.dates[`${a}`].startTime, e.dates[`${a}`].timeZone), e.dates[`${a}`].overdue = le("overdue", e.dates[`${a}`].endDate, e.dates[`${a}`].endTime, e.dates[`${a}`].timeZone);
    }
  else {
    const a = Te(e);
    e.dates = [], e.dates[0] = new Object(), e.startTime = e.dates[0].startTime = a.startTime, e.endTime = e.dates[0].endTime = a.endTime, e.timeZone = e.dates[0].timeZone = a.timeZone, e.startDate = e.dates[0].startDate = G(a.startDate), e.endDate = e.dates[0].endDate = G(a.endDate), e.dates[0].overdue = le("overdue", e.endDate, e.endTime, e.timeZone);
  }
  const t = /* @__PURE__ */ new Date();
  return (e.created == null || e.created == "") && (e.created = Y(t, "clean", !0)), (e.updated == null || e.updated == "") && (e.updated = Y(t, "clean", !0)), e;
}
function mt(e) {
  return (e.status == null || e.status == "") && (e.status = "CONFIRMED"), (e.sequence == null || e.sequence == "") && (e.sequence = 0), e;
}
function pt(e, t) {
  return e.dates[`${t}`].description != null && e.dates[`${t}`].description != "" ? (e.dates[`${t}`].description = e.dates[`${t}`].description.replace(/(\\r\\n|\\n|\\r|<br(\s|\s\/|\/|)>)/g, ""), e.dates[`${t}`].descriptionHtmlFree = B(e.dates[`${t}`].description, !0), e.dates[`${t}`].descriptionHtmlFreeICal = B(e.dates[`${t}`].description, !0, !0), e.dates[`${t}`].description = B(e.dates[`${t}`].description)) : e.dates[`${t}`].description == null && e.description != null && e.description != "" ? (e.description = e.description.replace(/(\\r\\n|\\n|\\r|<br(\s|\s\/|\/|)>)/g, ""), e.dates[`${t}`].descriptionHtmlFree = B(e.description, !0), e.dates[`${t}`].descriptionHtmlFreeICal = B(e.description, !0, !0), e.dates[`${t}`].description = B(e.description)) : e.dates[`${t}`].descriptionHtmlFree = e.dates[`${t}`].description = "", e;
}
function gt(e) {
  for (let t = 0; t < e.dates.length; t++)
    e = pt(e, t), (e.dates[`${t}`].name == null || e.dates[`${t}`].name == "") && (e.dates[`${t}`].name = e.name), e.dates[`${t}`].status == null ? e.dates[`${t}`].status = e.status.toUpperCase() : e.dates[`${t}`].status = e.dates[`${t}`].status.toUpperCase(), e.dates[`${t}`].sequence == null && (e.dates[`${t}`].sequence = e.sequence), e.dates[`${t}`].location == null && e.location != null && (e.dates[`${t}`].location = e.location), e.dates[`${t}`].organizer == null && e.organizer != null && (e.dates[`${t}`].organizer = e.organizer), e.dates[`${t}`].attendee == null && e.attendee != null && (e.dates[`${t}`].attendee = e.attendee), e.dates[`${t}`].availability == null && e.availability != null ? e.dates[`${t}`].availability = e.availability.toLowerCase() : e.dates[`${t}`].availability != null && (e.dates[`${t}`].availability = e.dates[`${t}`].availability.toLowerCase()), e.dates[`${t}`].uid == null && (t == 0 && e.uid != null && e.uid != "" ? e.dates[0].uid = e.uid : e.dates[`${t}`].uid = je());
  return e.recurrence != null && e.recurrence != "" && (e.dates[0].recurrence = e.recurrence), e.dates.length > 1 && e.dates.sort((t, a) => t.timestamp - a.timestamp), e;
}
function Te(e) {
  return (e.endDate == null || e.endDate == "") && (e.endDate = e.startDate), ["start", "end"].forEach(function(a) {
    if (e[a + "Date"] != null) {
      e[a + "Date"] = e[a + "Date"].replace(/\.\d{3}/, "").replace("Z", "");
      const n = e[a + "Date"].split("T");
...
function le(e, t, a = null, n = null) {
  const o = function() {
    return a ? /* @__PURE__ */ new Date(t + " " + a) : new Date(t);
  }();
  if (e === "timestamp")
    return o.getTime();
  try {
    let i = o.toISOString();
    if (a && n) {
      const c = se(n, t, a), d = c.slice(0, 3) + ":" + c.slice(3);
      i.replace(".000Z", d);
    }
    const r = new Date(i), l = new Date(Date.now()).toUTCString();
    return r.getTime() < new Date(l).getTime();
  } catch {
    return !1;
  }
}
...
function ht(e) {
  (e.pastDateHandling == null || e.pastDateHandling != "disable" && e.pastDateHandling != "hide") && (e.pastDateHandling = "none");
  const t = function() {
    for (let a = 0; a < e.dates.length; a++)
      if (!e.dates[`${a}`].endDate || !e.dates[`${a}`].overdue)
        return !1;
    return !0;
  }();
...
function ft(e) {
  if (e.validationError && (e.validationError = null), e.options == null || e.options.length < 1)
    return e.validationError = "Add to Calendar Button generation failed: no valid options set", !1;
  if (e.name == null || e.name == "")
    return e.validationError = "Add to Calendar Button generation failed: required name information missing", !1;
  if (e.dates != null && e.dates.length > 0) {
    const t = ["name", "startDate"], a = ["name"];
    return t.every(function(n) {
      for (let o = 0; o < e.dates.length; o++)
        if (!a.includes(`${n}`) && (e.dates[`${o}`][`${n}`] == null || e.dates[`${o}`][`${n}`] == "") || a.includes(`${n}`) && (e.dates[`${o}`][`${n}`] == null || e.dates[`${o}`][`${n}`] == "") && (e[`${n}`] == null || e[`${n}`] == ""))
          return e.validationError = "Add to Calendar Button generation failed: required setting missing [dates array object #" + (o + 1) + "/" + e.dates.length + "] => [" + n + "]", !1;
      return !0;
    });
  } else
    return ["startDate"].every(function(a) {
      return e[`${a}`] == null || e[`${a}`] == "" ? (e.validationError = "Add to Calendar Button generation failed: required setting missing [" + a + "]", !1) : !0;
    });
}
function xt(e) {
  e.validationError && (e.validationError = null);
  const t = "Add to Calendar Button generation (" + e.identifier + ")";
  return !(!Ze(e, t) || !vt(e, t) || !kt(e, t) || !yt(e, t) || !wt(e, t) || !Tt(e, t) || !zt(e, t) || !Rt(e, t) || e.recurrence_simplyfied && !Ct(e, t));
}
function Ze(e, t, a = "", n = "") {
  const o = function() {
    return a != "" && e.dates[`${a}`].icsFile != null ? e.dates[`${a}`].icsFile : a == "" && e.icsFile != null ? e.icsFile : "";
  }();
  return o != "" && (!ae(o, !1) || !e.icsFile.startsWith("https://")) ? (e.validationError = t + " failed: explicit ics file path not valid" + n, !1) : !0;
}
function vt(e, t) {
  return ["default", "3d", "flat", "round", "neumorphism", "text", "date", "custom", "none"].includes(e.buttonStyle) ? e.customCss != null && e.customCss != "" && (!ae(e.customCss, !1) || !/\.css$/m.test(e.customCss)) ? (e.validationError = t + " failed: customCss provided, but no valid url", !1) : (e.customCss == null || e.customCss == "") && e.buttonStyle == "custom" ? (e.validationError = t + ' failed: buttonStyle "custom" selected, but no customCss file provided', !1) : !0 : (e.validationError = t + " failed: provided buttonStyle invalid", !1);
}
function kt(e, t) {
  return e.subscribe == !0 && (e.icsFile == null || e.icsFile == "") ? (e.validationError = t + " failed: a subscription calendar requires a valid explicit ics file as well", !1) : !0;
}
function yt(e, t) {
  return /^\d{8}T\d{6}Z$/.test(e.created) ? !0 : (e.validationError = t + " failed: created date format not valid. Needs to be a full ISO-8601 UTC date and time string, formatted YYYYMMDDTHHMMSSZ", !1);
}
function wt(e, t) {
  return /^\d{8}T\d{6}Z$/.test(e.updated) ? !0 : (e.validationError = t + " failed: updated date format not valid. Needs to be a full ISO-8601 UTC date and time string, formatted YYYYMMDDTHHMMSSZ", !1);
}
function Tt(e, t) {
  return !!e.options.every(function(a) {
    return We.includes(a) ? !0 : (e.validationError = t + " failed: invalid option [" + a + "]", !1);
  });
}
function zt(e, t) {
  for (let a = 0; a < e.dates.length; a++) {
    ...
    if (!Ze(e, t, a, n) || !At(e, t, a, n) || !Et(e, t, a, n) || !Yt(e, t, a, n) || !St(e, t, a, n) || (Lt(e, t, a, n), _t(e, t, a, n), !Mt(e, t, a, n)) || !Dt(e, t, a, n))
      return !1;
  }
  return !0;
}
function At(e, t, a, n) {
  return e.dates[`${a}`].status != "TENTATIVE" && e.dates[`${a}`].status != "CONFIRMED" && e.dates[`${a}`].status != "CANCELLED" ? (e.validationError = t + " failed: event status needs to be TENTATIVE, CONFIRMED, or CANCELLED" + n, !1) : !0;
}
function Et(e, t, a, n) {
  return e.dates[`${a}`].availability != null && e.dates[`${a}`].availability != "" && e.dates[`${a}`].availability != "free" && e.dates[`${a}`].availability != "busy" ? (e.validationError = t + ' failed: event availability needs to be "free" or "busy"' + n, !1) : !0;
}
function Yt(e, t, a, n) {
  if (e.dates[`${a}`].organizer != null && e.dates[`${a}`].organizer != "") {
    const o = e.dates[`${a}`].organizer.split("|");
    if (o.length != 2 || o[0].length > 50 || o[1].length > 80 || !qe(o[1]))
      return e.validationError = t + ' failed: organizer needs to match the schema "NAME|EMAIL" with a valid email address' + n, !1;
  }
  return !0;
}
function St(e, t, a, n) {
  if (e.dates[`${a}`].attendee != null && e.dates[`${a}`].attendee != "") {
    if (e.dates[`${a}`].organizer == null || e.dates[`${a}`].organizer == "")
      return e.validationError = t + " failed: if an attendee is set, you also need to set the organizer" + n, !1;
    const o = e.dates[`${a}`].attendee.split("|");
    if (o.length != 2 || o[0].length > 50 || o[1].length > 80 || !qe(o[1]))
      return e.validationError = t + ' failed: attendee needs to match the schema "NAME|EMAIL" with a valid email address' + n, !1;
  }
  return !0;
}
function Lt(e, t, a, n) {
  return /^(\w|-){1,254}$/.test(e.dates[`${a}`].uid) || (e.debug && console.warn(t + ": UID not valid. May only contain alpha, digits, and dashes; and be less than 255 characters. Falling back to an automated value!" + n), e.dates[`${a}`].uid = je()), !/^[0-9a-f]{8}-[0-9a-f]{4}-[0-5][0-9a-f]{3}-[089ab][0-9a-f]{3}-[0-9a-f]{12}$/i.test(e.dates[`${a}`].uid) && e.debug && console.warn(t + ": UID is highly recommended to be a hex-encoded random Universally Unique Identifier (UUID)!" + n), !0;
}
function _t(e, t, a, n) {
  return /^\d+$/.test(e.dates[`${a}`].sequence) || (e.debug && console.log(t + ": sequence needs to be a number. Used the default 0 instead" + n), e.dates[`${a}`].sequence = 0), !0;
}
function Mt(e, t, a, n) {
  return e.dates[`${a}`].timeZone != null && e.dates[`${a}`].timeZone != "" && !Ke().includes(e.dates[`${a}`].timeZone) ? (e.validationError = t + " failed: invalid time zone given" + n, !1) : !0;
}
function Dt(e, t, a, n) {
  const o = ["startDate", "endDate"], i = o;
  return !o.every(function(l) {
    if (e.dates[`${a}`][`${l}`].length !== 10)
      return e.validationError = t + " failed: date misspelled [-> YYYY-MM-DD]" + n, !1;
    const c = e.dates[`${a}`][`${l}`].split("-");
    return c.length < 3 || c.length > 3 ? (e.validationError = t + " failed: date misspelled [" + l + ": " + e.dates[`${a}`][`${l}`] + "]" + n, !1) : (i[`${l}`] = new Date(c[0], c[1] - 1, c[2]), !0);
    ...
    if (e.dates[`${a}`][`${l}`] != null) {
      ...
      if (c.length < 2 || c.length > 2)
        return e.validationError = t + " failed: time misspelled [" + l + ": " + e.dates[`${a}`][`${l}`] + "]" + n, !1;
      if (c[0] > 23)
        return e.validationError = t + " failed: time misspelled - hours number too high [" + l + ": " + c[0] + "]" + n, !1;
      if (c[1] > 59)
        return e.validationError = t + " failed: time misspelled - minutes number too high [" + l + ": " + c[1] + "]" + n, !1;
      l == "startTime" && (i.startDate = new Date(i.startDate.getTime() + c[0] * 36e5 + c[1] * 6e4)), l == "endTime" && (i.endDate = new Date(i.endDate.getTime() + c[0] * 36e5 + c[1] * 6e4));
    }
    return !0;
  }) ? !1 : e.dates[`${a}`].startTime != null && e.dates[`${a}`].endTime == null || e.dates[`${a}`].startTime == null && e.dates[`${a}`].endTime != null ? (e.validationError = t + " failed: if you set a starting or end time, the respective other one also needs to be defined" + n, !1) : i.endDate < i.startDate ? (e.validationError = t + " failed: end date before start date" + n, !1) : !0;
}
function Rt(e, t) {
  return e.recurrence != null && e.recurrence != "" && e.dates.length > 1 ? (e.validationError = t + " failed: RRULE and multi-date set at the same time", !1) : e.recurrence != null && e.recurrence != "" && !/^RRULE:[\w=;,:+-/\\]+$/i.test(e.recurrence) ? (e.validationError = t + " failed: RRULE data misspelled", !1) : !0;
}
function Ct(e, t) {
  return e.recurrence_interval != null && e.recurrence_interval != "" && !/^\d+$/.test(e.recurrence_interval) ? (e.validationError = t + " failed: recurrence data (interval) misspelled", !1) : e.recurrence_until != null && e.recurrence_until != "" && !/^(\d|-|:)+$/i.test(e.recurrence_until) ? (e.validationError = t + " failed: recurrence data (until) misspelled", !1) : e.recurrence_count != null && e.recurrence_count != "" && !/^\d+$/.test(e.recurrence_count) ? (e.validationError = t + " failed: recurrence data (interval) misspelled", !1) : e.recurrence_byMonth != null && e.recurrence_byMonth != "" && !/^(\d|,)+$/.test(e.recurrence_byMonth) ? (e.validationError = t + " failed: recurrence data (byMonth) misspelled", !1) : e.recurrence_byMonthDay != null && e.recurrence_byMonthDay != "" && !/^(\d|,)+$/.test(e.recurrence_byMonthDay) ? (e.validationError = t + " failed: recurrence data (byMonthDay) misspelled", !1) : e.recurrence_byDay != null && e.recurrence_byDay != "" && !/^(\d|-|MO|TU|WE|TH|FR|SA|SU|,)+$/im.test(e.recurrence_byDay) ? (e.validationError = t + " failed: recurrence data (byDay) misspelled", !1) : e.recurrence_weekstart != null && e.recurrence_weekstart != "" && !/^(MO|TU|WE|TH|FR|SA|SU)$/im.test(e.recurrence_weekstart) ? (e.validationError = t + " failed: recurrence data (weekstart) misspelled", !1) : !0;
}
function A(e, t, a = "", n = null, o = !1, i = !1) {
  t == "open" ? ze(e, a, n, o, i) : t == "close" || n.classList.contains("atcb-active") || e.querySelector(".atcb-active-modal") ? V(e, o) : ze(e, a, n, o, i);
}
function ze(e, t, a = null, n = !1, o = !1) {
  if (e.querySelector(".atcb-list") || e.querySelector(".atcb-modal"))
    return;
  z("openList", t.identifier, t.identifier), k.active = t.identifier;
  const i = Ut(e, t), r = document.createElement("div");
  if (r.classList.add("atcb-list-wrapper"), t.hideTextLabelList && r.classList.add("atcb-no-text"), a ? (a.classList.add("atcb-active"), t.listStyle === "modal" ? (a.classList.add("atcb-modal-style"), i.classList.add("atcb-modal")) : (r.append(i), r.classList.add("atcb-dropdown"), t.listStyle === "overlay" && r.classList.add("atcb-dropoverlay")), o && i.classList.add("atcb-generated-button")) : i.classList.add("atcb-modal"), t.listStyle === "modal") {
    const c = me(e, t.trigger, !0, !t.hideBackground), d = Fe(e, t);
    d.append(c), c.append(i), t.hideBranding || pe(d, !1), ee(i, t.sizes), ve(d), X(c);
  } else {
    const c = me(e, t.trigger, !1, !t.hideBackground);
    e.querySelector(".atcb-initialized").append(r), r.append(i), t.buttonStyle != "default" && r.classList.add("atcb-style-" + t.buttonStyle), t.hideBranding || pe(e), e.append(c), ee(i, t.sizes), r.style.display = "none", setTimeout(function() {
      r.style.display = "block", t.listStyle === "dropdown-static" ? De(e, a, r, !0) : De(e, a, r);
    }, 5), X(c);
  }
  const l = function() {
    const c = e.querySelector(".atcb-list-item");
    if (c)
      return c;
    const d = document.getElementById(t.identifier + "-modal-host");
    if (d)
      return d.shadowRoot.querySelector(".atcb-list-item");
  }();
  l && (n ? l.focus() : (l.focus({ preventScroll: !0 }), l.blur()));
}
function V(e, t = !1) {
  const a = document.getElementById(e.host.getAttribute("atcb-button-id") + "-modal-host"), n = function() {
  ...
  if (n.length > 1) {
    ...
    const o = a.shadowRoot.querySelectorAll('.atcb-modal[data-modal-nr="' + (n.length - 1) + '"]')[0];
    o.style.display = "block";
    let i = o;
    const r = o.getElementsByTagName("button");
    r.length > 0 && (i = r[0]), i.focus(), t || i.blur();
  } else {
    const o = function() {
      const i = e.querySelector(".atcb-active, .atcb-active-modal");
      return i || document.querySelector(".atcb-active, .atcb-active-modal");
    }();
    o && (o.focus({ preventScroll: !0 }), t || o.blur()), Array.from(e.querySelectorAll(".atcb-active")).forEach((i) => {
      ...
      i.classList.remove("atcb-active-modal");
    }), a && a.remove(), document.body.classList.remove("atcb-modal-no-scroll"), document.documentElement.classList.remove("atcb-modal-no-scroll"), Array.from(e.querySelectorAll(".atcb-list-wrapper")).concat(Array.from(e.querySelectorAll(".atcb-list"))).concat(Array.from(e.querySelectorAll("#add-to-calendar-button-reference"))).concat(Array.from(e.querySelectorAll("#atcb-bgoverlay"))).forEach((i) => i.remove()), k.active = "";
  }
}
function W(e, t, a, n, o = !1, i = "", r = !1) {
  switch (n) {
    case "trigger":
    default:
      a.id = t.identifier, t.blockInteraction || (a.addEventListener("keyup", function(l) {
        l.key == "Enter" && (l.preventDefault(), A(e, "auto", t, a, !0, !0));
      }), a.addEventListener(
        "touchend",
        R((l) => {
          l.preventDefault(), A(e, "auto", t, a, !1, !0);
        })
      ), t.trigger === "click" ? a.addEventListener(
        "mouseup",
        R((l) => {
          l.preventDefault(), A(e, "auto", t, a, !1, !0);
        })
        ...
        "mouseenter",
        R((l) => {
          l.preventDefault(), A(e, "open", t, a, !1, !0);
        })
      ));
      break;
    case "apple":
    ...
    case "outlookcom":
    case "yahoo":
      a.id = t.identifier + "-" + n, t.blockInteraction || (a.addEventListener(
        "click",
        R(() => {
          r ? (e.querySelector("#" + a.id).blur(), z("openSingletonLink", a.id, t.identifier)) : (A(e, "close"), z("openCalendarLink", a.id, t.identifier)), J(e, n, t);
        })
      ), a.addEventListener("keyup", function(l) {
        l.key == "Enter" && (l.preventDefault(), r ? (e.querySelector("#" + a.id).blur(), z("openSingletonLink", a.id, t.identifier)) : (A(e, "close"), z("openCalendarLink", a.id, t.identifier)), J(e, n, t, "all", !0));
      }));
      break;
    case "close":
      a.id = t.identifier + "-close", a.addEventListener(
        "click",
        P(() => {
          z("closeList", "List Close Button", k.active), A(e, "close");
        })
      ), a.addEventListener("keyup", function(l) {
        l.key == "Enter" && (l.preventDefault(), z("closeList", "List Close Button", k.active), A(e, "close", t, "all", !0));
      });
      break;
  }
  Bt(t, a, n, o, i, r);
}
function Bt(e, t, a, n, o, i) {
  const r = function() {
    return e.dates[0].overdue && e.pastDateHandling != "none" ? p("expired", e) : p("label.addtocalendar", e);
  }();
  if (i && o == "" && (o = r), o = {
    trigger: o || r,
    apple: o || "Apple",
    google: o || "Google",
    ical: o || p("label.icalfile", e),
    msteams: o || "Microsoft Teams",
    ms365: o || "Microsoft 365",
    outlookcom: o || "Outlook.com",
    yahoo: o || "Yahoo",
    close: p("close", e)
  }[`${a}`], !(e.buttonStyle == "date" && (a == "trigger" || i))) {
    if (n) {
      const c = document.createElement("span");
      c.classList.add("atcb-icon"), c.innerHTML = $[`${a}`], t.append(c);
    }
    if ((a == "trigger" || i) && !e.hideTextLabelButton || !i && a != "trigger" && !e.hideTextLabelList) {
      const c = document.createElement("span");
...
function $t(e, t, a, n = !1) {
  ...
  (o ? a.options : ["default"]).forEach(function(r) {
    const l = document.createElement("div");
    l.classList.add("atcb-button-wrapper"), a.rtl && l.classList.add("atcb-rtl"), t.append(l), ee(l, a.sizes);
    const c = document.createElement("button");
    if (c.classList.add("atcb-button"), a.disabled && (c.setAttribute("disabled", !0), c.style.cssText = "opacity: .75; cursor: not-allowed; filter: brightness(95%); border-style: dashed;"), a.hideTextLabelButton && c.classList.add("atcb-no-text"), a.trigger === "click" && c.classList.add("atcb-click"), a.listStyle === "overlay" && c.classList.add("atcb-dropoverlay"), c.type = "button", l.append(c), a.buttonStyle == "date" && Ie(a, c), o)
      c.classList.add("atcb-single"), W(e, a, c, r, !a.hideIconButton, a.label, !0), c.id = a.identifier, a.buttonsList && (c.id = a.identifier + "-" + r);
    else {
      W(e, a, c, "trigger", !a.hideIconButton, a.label);
      const d = document.createElement("div");
      d.classList.add("atcb-dropdown-anchor"), c.append(d);
    }
    if (!a.hideCheckmark && !a.hideTextLabelButton && !a.buttonsList && !a.disabled) {
      const d = document.createElement("div");
      d.classList.add("atcb-checkmark"), d.innerHTML = $.checkmark, c.append(d);
    }
...
function Ut(e, t) {
  ...
  let n = 0;
  if (t.options.forEach(function(o) {
    const i = document.createElement("div");
    i.classList.add("atcb-list-item"), i.role = "link", i.tabIndex = 0, n++, i.dataset.optionNumber = n, a.append(i), W(e, t, i, o, !t.hideIconList, t.optionLabels[n - 1]);
  }), t.listStyle === "modal") {
    const o = document.createElement("div");
    o.classList.add("atcb-list-item", "atcb-list-item-close"), o.role = "button", o.tabIndex = 0, n++, o.dataset.optionNumber = n, a.append(o), W(e, t, o, "close", !t.hideIconList);
  }
  return a;
}
function me(e, t = "", a = !1, n = !0) {
  const o = function() {
    return a ? document.createElement("dialog") : document.createElement("div");
  }();
  a && o.setAttribute("open", !0), o.id = "atcb-bgoverlay", n || o.classList.add("atcb-no-bg"), o.role = "button", o.tabIndex = 0, o.addEventListener(
    "mouseup",
    R((r) => {
      r.target === r.currentTarget && (z("closeList", "Background Hit", k.active), A(e, "close"));
    })
  );
  let i = !1;
  return o.addEventListener(
    ...
    "touchend",
    P((r) => {
      i !== !1 || r.target !== r.currentTarget || (z("closeList", "Background Hit", k.active), A(e, "close"));
    }),
    { passive: !0 }
  ), t !== "click" ? o.addEventListener(
    "mousemove",
    R((r) => {
      r.target === r.currentTarget && (z("closeList", "Background Hit", k.active), A(e, "close"));
    })
...
function pe(e, t = !0) {
  const a = document.createElement("div");
  a.id = "add-to-calendar-button-reference", a.style.cssText = "width: 130px; padding: 5px; height: auto; opacity: .8; transform: translate3d(0, 0, 0); z-index: 15000000;", setTimeout(() => {
    a.innerHTML = '<a href="https://add-to-calendar-pro.com" target="_blank" rel="noopener">' + $.atcb + "</a>";
  }, 500), t ? e.querySelector(".atcb-initialized .atcb-list-wrapper").append(a) : (window.innerHeight > 1e3 || window.innerWidth > 1e3) && (e.append(a), a.style.cssText += "position: fixed; bottom: 15px; right: 30px;");
}
function Z(e, t, a = "", n, o = "", i = [], r = [], l = !1) {
  k.active = t.identifier;
  const c = Fe(e, t, !1), d = function() {
    const u = c.getElementById("atcb-bgoverlay");
    if (!u) {
      const y = me(e, "click", !0, !t.hideBackground);
      return c.append(y), y;
    }
    return u;
  }(), h = document.createElement("div");
  h.classList.add("atcb-modal"), d.append(h);
  const b = c.querySelectorAll(".atcb-modal").length;
  h.dataset.modalNr = b, h.tabIndex = 0, h.focus({ preventScroll: !0 }), h.blur();
  const s = function() {
    const u = e.getElementById(t.identifier);
    return u || document.getElementById(t.identifier);
  }();
  s && s.classList.add("atcb-active-modal");
  const m = document.createElement("div");
  if (m.classList.add("atcb-modal-box"), t.rtl && m.classList.add("atcb-rtl"), h.append(m), ee(m, t.sizes), X(d), a != "" && !t.hideIconModal) {
    const u = document.createElement("div");
    u.classList.add("atcb-modal-icon"), u.innerHTML = $[`${a}`], m.append(u);
  }
  const T = document.createElement("div");
  if (T.classList.add("atcb-modal-headline"), T.textContent = n, m.append(T), o != "") {
    const u = document.createElement("div");
    u.classList.add("atcb-modal-content"), u.innerHTML = o, m.append(u);
  }
  if (r.length > 1) {
    t.hideBranding || pe(c, !1);
    const u = document.createElement("div");
    u.classList.add("atcb-modal-content"), m.append(u);
    for (let y = 1; y < r.length; y++) {
      const g = document.createElement("button");
      g.type = "button", g.id = t.identifier + "-" + r[0] + "-" + y, k[`${t.identifier}`][`${r[0]}`][y - 1] > 0 && g.classList.add("atcb-saved"), g.classList.add("atcb-subevent-btn"), u.append(g), Ie(t, g, y), y == 1 && l && g.focus(), g.addEventListener(
        "click",
        P(() => {
          z("openSubEventLink", g.id, t.identifier), J(e, r[0], t, r[`${y}`], l, !0);
        })
      );
    }
  }
  i.length == 0 && i.push({ type: "close", label: p("close", t) });
  const v = document.createElement("div");
  if (v.classList.add("atcb-modal-buttons"), m.append(v), i.forEach((u, y) => {
    let g;
    switch (u.href != null && u.href != "" ? (g = document.createElement("a"), g.setAttribute("target", xe), g.setAttribute("href", u.href), g.setAttribute("rel", "noopener")) : (g = document.createElement("button"), g.type = "button"), g.classList.add("atcb-modal-btn"), u.primary && g.classList.add("atcb-modal-btn-primary"), (u.label == null || u.label == "") && (u.label = p("modal.button.default", t)), g.textContent = u.label, v.append(g), y == 0 && r.length < 2 && l && g.focus(), u.type) {
      default:
      case "close":
        g.addEventListener(
          "click",
          P(() => {
            z("closeList", "Modal Close Button", k.active), V(e);
          })
        ), g.addEventListener("keyup", function(f) {
          f.key == "Enter" && (z("closeList", "Modal Close Button", k.active), A(e, "close", "", "", !0));
        });
        break;
      case "yahoo2nd":
        g.addEventListener(
          ...
          f.key == "Enter" && (A(e, "close", "", "", !0), Ae(e, t, l));
        });
        break;
      case "none":
        break;
    ...
    const u = c.querySelector('.atcb-modal[data-modal-nr="' + (b - 1) + '"]');
    u.style.display = "none";
  }
  ve(c, h);
}
function Ae(e, t, a) {
  te(e, t), J(e, "yahoo2nd", t, "all", a);
}
function Ie(e, t, a = "all") {
  a != "all" ? a = parseInt(a) - 1 : e.dates.length == 1 && (a = 0);
  const n = function() {
    let f, x, w, S, D = {}, O = {};
    a == "all" ? (D = L(e.dates[0]), O = L(e.dates[e.dates.length - 1]), w = e.dates[0].timeZone, S = e.dates[e.dates.length - 1].timeZone) : (D = L(e.dates[`${a}`]), O = D, w = e.dates[`${a}`].timeZone, S = w), f = new Date(D.start), x = new Date(O.end), (w == null || w == "" || D.allday) && (w = "UTC"), (S == null || S == "" || O.allday) && (S = "UTC");
    let _ = "", ne = "", oe = "";
    !D.allday && Intl.DateTimeFormat().resolvedOptions().timeZone != w && w != S && (ne = " (" + w + ")"), (!O.allday && Intl.DateTimeFormat().resolvedOptions().timeZone != S || w != S) && (oe = " (" + S + ")");
    const j = Ee(w), I = Ee(S);
    return f.toLocaleDateString(e.language, I.DateLong) === x.toLocaleDateString(e.language, I.DateLong) ? D.allday ? _ = f.toLocaleDateString(e.language, j.DateShort) : _ = f.toLocaleString(e.language, j.DateTimeShort) + ne + " - " + x.toLocaleTimeString(e.language, I.Time) + oe : (D.allday ? _ = f.toLocaleDateString(e.language, j.DateShort) : _ = f.toLocaleString(e.language, j.DateTimeShort), _ += ne + " - ", O.allday ? _ += x.toLocaleDateString(e.language, I.DateLong) : _ += x.toLocaleString(e.language, I.DateTimeLong), _ += oe), _;
  }(), o = function() {
    return a != "all" && e.dates[`${a}`].status == "CANCELLED" ? p("date.status.cancelled", e) + "<br>" + p("date.status.cancelled.cta", e) : e.dates[`${a}`].overdue && e.pastDateHandling != "none" ? p("expired", e) : "+ " + p("label.addtocalendar", e);
  }(), i = function() {
    return a != "all" && e.dates[`${a}`].status == "CANCELLED" ? p("date.status.cancelled", e) : "";
  }();
  a == "all" && (a = 0);
  const r = new Date(L(e.dates[`${a}`]).start), l = L(e.dates[`${a}`]).allday, c = function() {
    return e.dates[`${a}`].timeZone != null && e.dates[`${a}`].timeZone != "" ? e.dates[`${a}`].timeZone : "UTC";
  }(), d = document.createElement("div");
  d.classList.add("atcb-date-btn-left"), t.append(d);
  const h = document.createElement("div");
  h.classList.add("atcb-date-btn-day"), d.append(h);
  const b = document.createElement("div");
  b.classList.add("atcb-date-btn-month"), h.textContent = function() {
    return l ? r.toLocaleString(e.language, { day: "numeric" }) : r.toLocaleString(e.language, {
      day: "numeric",
      timeZone: c
    });
  }(), b.textContent = function() {
    return l ? r.toLocaleString(e.language, { month: "short" }) : r.toLocaleString(e.language, {
      month: "short",
      timeZone: c
    });
  }(), d.append(b);
  const s = document.createElement("div");
  s.classList.add("atcb-date-btn-right"), t.append(s);
  const m = document.createElement("div");
  m.classList.add("atcb-date-btn-details"), s.append(m);
  const T = document.createElement("div");
  if (T.classList.add("atcb-date-btn-headline"), T.textContent = e.dates[`${a}`].name, m.append(T), e.location != null && e.location != "" || i != "") {
    const f = document.createElement("div");
    if (f.classList.add("atcb-date-btn-content"), m.append(f), i != "")
      f.textContent = i, f.style.fontWeight = "600", f.style.color = "#9c1a23";
    else {
      f.classList.add("atcb-date-btn-content-location");
      const x = document.createElement("span");
      x.classList.add("atcb-date-btn-content-icon"), x.innerHTML = $.location, f.append(x);
      const w = document.createElement("span");
      w.textContent = e.location, f.append(w);
    }
  } else
    T.style.cssText = "-webkit-line-clamp: 2";
  const v = document.createElement("div");
  v.classList.add("atcb-date-btn-content"), m.append(v);
  const u = document.createElement("span");
  u.classList.add("atcb-date-btn-content-icon"), u.innerHTML = $.ical, v.append(u);
  const y = document.createElement("span");
  if (y.textContent = n, v.append(y), e.recurrence != null && e.recurrence != "") {
    const f = document.createElement("span");
    f.classList.add("atcb-date-btn-content-recurr-icon"), v.append(f), f.innerHTML = "&#x27F3;";
  }
  const g = document.createElement("div");
  if (g.classList.add("atcb-date-btn-hover"), g.innerHTML = o, s.append(g), !e.hideCheckmark) {
    const f = document.createElement("div");
    f.classList.add("atcb-checkmark"), f.innerHTML = $.checkmark, t.append(f);
  }
}
function Ee(e) {
  return {
...
function Fe(e, t, a = !0) {
  const n = document.getElementById(t.identifier + "-modal-host");
  if (!a && n)
    return n.shadowRoot;
  n && n.remove();
  let o = document.createElement("div");
  o.id = t.identifier + "-modal-host", e.host.hasAttribute("styleLight") && o.setAttribute("styleLight", e.host.getAttribute("styleLight")), e.host.hasAttribute("styleDark") && o.setAttribute("styleDark", e.host.getAttribute("styleDark")), o.setAttribute("atcb-button-id", t.identifier), document.body.append(o), o.attachShadow({ mode: "open", delegateFocus: !0 });
  const i = document.createElement("template");
  return i.innerHTML = '<div class="atcb-modal-host-initialized" style="position:relative;"></div>', o.shadowRoot.append(i.content.cloneNode(!0)), ke(o.shadowRoot, t), Qe(o.shadowRoot, null, t.buttonStyle, !1, !1, t.customCss), o.shadowRoot;
}
function Ot(e, t) {
  ...
  if (e.dates.length > 1) {
    const i = [];
    i.push('"@context":"https://schema.org"'), i.push('"@type":"EventSeries"'), i.push('"@id":"' + e.name.replace(/\s/g, "") + '"'), i.push('"name":"' + e.name + '",'), n.push(`{\r
` + i.join(`,\r
`) + `\r
`);
  }
  ...
  for (let i = 0; i < e.dates.length; i++) {
    const r = [];
    r.push('"@context":"https://schema.org"'), r.push('"@type":"Event"'), e.dates.length > 1 && r.push('"@id":"' + e.name.replace(/\s/g, "") + "-" + (i + 1) + '"'), e.dates[`${i}`].status == "CANCELLED" && r.push('"eventStatus":"https://schema.org/EventCancelled"'), r.push('"name":"' + e.dates[`${i}`].name + '"'), e.dates[`${i}`].descriptionHtmlFree && r.push('"description":"' + e.dates[`${i}`].descriptionHtmlFree + '"');
    const l = L(e.dates[`${i}`], "delimiters", "general", !0);
    if (r.push('"startDate":"' + l.start + '"'), l.duration != null && r.push('"duration":"' + l.duration + '"'), r.push(e.dates[`${i}`].location.startsWith("http") ? `"eventAttendanceMode":"https://schema.org/OnlineEventAttendanceMode",\r
"location": {\r
"@type":"VirtualLocation",\r
"url":"` + e.dates[`${i}`].location + `"\r
}` : '"location":"' + e.dates[`${i}`].location + '"'), e.recurrence != null && e.recurrence != "" ? r.push(...Ht(e, l)) : r.push('"endDate":"' + l.end + '"'), e.dates[`${i}`].organizer != null && e.dates[`${i}`].organizer != "") {
      const d = e.dates[`${i}`].organizer.split("|");
      r.push(`"organizer":{\r
"@type":"Person",\r
"name":"` + d[0] + `",\r
"email":"` + d[1] + `"\r
    ...
    if (e.images != null) {
      if (Array.isArray(e.images))
        for (let d = 0; d < e.images.length; d++)
          ae(e.images[`${d}`], e.debug) && e.images[`${d}`].startsWith("http") && c.push('"' + e.images[`${d}`] + '"');
    } else
...
}` : a.textContent = o[0], t.parentNode.insertBefore(a, t);
}
function Ht(e, t) {
  const a = [];
  a.push('"eventSchedule": { "@type": "Schedule"'), e.dates[0].timeZone != null && e.dates[0].timeZone != "" && a.push('"scheduleTimezone":"' + e.dates[0].timeZone + '"');
  const n = "P" + e.recurrence_interval + e.recurrence_frequency.substring(0, 1);
  if (a.push('"repeatFrequency":"' + n + '"'), e.recurrence_byDay != null && e.recurrence_byDay != "") {
    const o = function() {
      if (/\d/.test(e.recurrence_byDay))
        return '"' + e.recurrence_byDay + '"';
      {
        const i = e.recurrence_byDay.split(","), r = {
...
function J(e, t, a, n = "all", o = !1, i = !1) {
  ...
  if (n != "all") {
    ...
    if (l) {
      const d = l.shadowRoot.getElementById(a.identifier + "-" + t + "-" + (n + 1));
      d && d.classList.add("atcb-saved");
    }
    k[`${a.identifier}`][`${t}`][`${n}`]++, k[`${a.identifier}`][`${t}`].filter(function(d) {
      return d < 1;
    }).length == 0 && te(e, a, i);
    return;
  }
...
function Nt(e, t, a, n, o, i) {
  if (a == "ical" && n.dates.every(function(r) {
    return !(r.status == "CANCELLED" || r.organizer != null && r.organizer != "");
  })) {
    Pe(e, n, "all", o);
    for (let r = 0; r < k[`${n.identifier}`][`${t}`].length; r++)
      k[`${n.identifier}`][`${t}`][`${r}`]++;
    te(e, n, i);
    return;
  }
  if (!i) {
    ...
    for (let l = 0; l < n.dates.length; l++)
      r.push(l + 1);
    Z(e, n, t, p("modal.multidate.h", n), p("modal.multidate.text", n), [], r, o);
  }
}
function Zt(e, t, a, n) {
  ...
  switch (t) {
    ...
    case "yahoo":
      ge(a.icsFile), Z(
        ...
        a,
        "yahoo",
        p("modal.subscribe.yahoo.h", a),
        p("modal.clipboard.text", a) + "<br>" + p("modal.subscribe.yahoo.text", a),
        [
          {
            label: p("Open Yahoo Calendar", a),
            primary: !0,
            type: "yahoo2nd",
...
function te(e, t, a = !1) {
  const n = e.getElementById(t.identifier);
  n && n.classList.add("atcb-saved"), Gt(e, t), a && e.querySelectorAll(".atcb-modal[data-modal-nr]").length < 2 && A(e, "close");
}
function Ye(e) {
  U(e);
}
function It(e) {
  const t = "https://calendar.google.com/calendar/r?cid=", a = function() {
    return e.startsWith("https://calendar.google.com/") || e.startsWith("webcal://calendar.google.com/") || e.startsWith("http://calendar.google.com/") || e.startsWith("//calendar.google.com/") ? e.replace(/^(.)*\?cid=/, "") : encodeURIComponent(e);
  }();
  U(t + a);
}
function Se(e, t, a = "365") {
  const n = [], o = function() {
    return a == "outlook" ? "https://outlook.live.com/calendar/0/addfromweb/?" : "https://outlook.office.com/calendar/0/addfromweb/?";
  }();
  n.push("url=" + encodeURIComponent(e)), n.push("name=" + encodeURIComponent(t)), U(o + n.join("&"));
}
function Ft(e) {
  const t = [];
  t.push("https://calendar.google.com/calendar/render?action=TEMPLATE");
  const a = L(e, "clean", "google");
  if (t.push("dates=" + encodeURIComponent(a.start) + "%2F" + encodeURIComponent(a.end)), e.timeZone != null && e.timeZone != "" && !/(GMT[+|-]\d{1,2}|Etc\/U|Etc\/Zulu|CET|CST6CDT|EET|EST|EST5EDT|MET|MST|MST7MDT|PST8PDT|WET)/i.test(e.timeZone) && !a.allday && t.push("ctz=" + e.timeZone), e.name != null && e.name != "" && t.push("text=" + encodeURIComponent(e.name)), e.description != null && e.description != "" && t.push("details=" + encodeURIComponent(e.description)), e.location != null && e.location != "" && t.push("location=" + encodeURIComponent(e.location)), e.recurrence != null && e.recurrence != "" && t.push("recur=" + encodeURIComponent(e.recurrence)), e.availability != null && e.availability != "") {
    const n = function() {
      return e.availability == "free" ? "crm=AVAILABLE&trp=false" : "crm=BUSY&trp=true";
    }();
    t.push(n);
  }
  t.push("uid=" + encodeURIComponent(e.uid)), U(t.join("&"));
}
function Pt(e) {
  const t = [];
  t.push("https://calendar.yahoo.com/?v=60");
  const a = L(e, "clean");
  t.push("st=" + encodeURIComponent(a.start) + "&et=" + encodeURIComponent(a.end)), a.allday && t.push("dur=allday"), e.name != null && e.name != "" && t.push("title=" + encodeURIComponent(e.name)), e.location != null && e.location != "" && t.push("in_loc=" + encodeURIComponent(e.location)), e.descriptionHtmlFree != null && e.descriptionHtmlFree != "" && t.push("desc=" + encodeURIComponent(e.descriptionHtmlFree)), U(t.join("&"));
}
function Le(e, t = "365") {
  const a = [], n = function() {
    return N() ? "/calendar/0/deeplink/compose?path=%2Fcalendar%2Faction%2Fcompose&rru=addevent" : "/calendar/action/compose?rru=addevent";
  }(), o = function() {
    return t == "outlook" ? "https://outlook.live.com" + n : "https://outlook.office.com" + n;
  }();
  a.push(o);
  const i = L(e, "delimiters", "microsoft");
  a.push("startdt=" + i.start), a.push("enddt=" + i.end), i.allday && a.push("allday=true"), e.name != null && e.name != "" && a.push("subject=" + encodeURIComponent(e.name)), e.location != null && e.location != "" && a.push("location=" + encodeURIComponent(e.location)), e.description != null && e.description != "" && a.push("body=" + encodeURIComponent(e.description)), a.push("uid=" + encodeURIComponent(e.uid)), U(a.join("&"));
}
function qt(e) {
  const t = [], a = "https://teams.microsoft.com/l/meeting/new?", n = L(e, "delimiters", "msteams", !0);
  !n.allday || N() ? (t.push("startTime=" + encodeURIComponent(n.start)), t.push("endTime=" + encodeURIComponent(n.end))) : (t.push("startTime=" + n.start), t.push("endTime=" + n.end)), e.name != null && e.name != "" && t.push("subject=" + encodeURIComponent(e.name));
  let o = "";
  e.location != null && e.location != "" && (o = encodeURIComponent(e.location), t.push("location=" + o), o += " // "), e.descriptionHtmlFree != null && e.descriptionHtmlFree != "" && t.push("content=" + o + encodeURIComponent(e.descriptionHtmlFree)), t.push("uid=" + encodeURIComponent(e.uid)), U(a + t.join("&"));
}
function U(e, t = "") {
  if (t == "" && (t = xe), ae(e)) {
    const a = window.open(e, t);
    a && a.focus();
  }
}
function Pe(e, t, a = "all", n = !1) {
  a != "all" && (a = parseInt(a));
  const o = jt(t, a), i = function() {
    return a != "all" && t.dates[`${a}`].icsFile != null && t.dates[`${a}`].icsFile != "" ? t.dates[`${a}`].icsFile : t.icsFile != null && t.icsFile != "" ? t.icsFile : "";
  }();
  if (i != "" && (!C() || !de() || t.bypassWebViewCheck == !0)) {
    _e(i, o);
    return;
  }
  const r = /* @__PURE__ */ new Date(), l = ["BEGIN:VCALENDAR", "VERSION:2.0"];
  l.push("PRODID:-// https://add-to-calendar-pro.com // button v" + Oe + " //EN"), l.push("CALSCALE:GREGORIAN"), a == "all" ? l.push("METHOD:PUBLISH") : t.dates[`${a}`].status != null && t.dates[`${a}`].status == "CANCELLED" ? l.push("METHOD:CANCEL") : t.dates[`${a}`].organizer != null && t.dates[`${a}`].organizer != "" ? l.push("METHOD:REQUEST") : l.push("METHOD:PUBLISH");
  const c = [], d = function() {
    return a != "all" ? a : 0;
  }(), h = function() {
  ...
  for (let s = d; s <= h; s++) {
    const m = L(t.dates[`${s}`], "clean", "ical"), T = function() {
      if (m.allday)
        return ";VALUE=DATE";
      if (t.dates[`${s}`].timeZone != null && t.dates[`${s}`].timeZone != "") {
        const v = Ge(t.dates[`${s}`].timeZone);
        return c.includes(t.dates[`${s}`].timeZone) || l.push(v[0]), c.push(t.dates[`${s}`].timeZone), ";" + v[1];
      }
    }();
    if (l.push("BEGIN:VEVENT"), l.push("UID:" + t.dates[`${s}`].uid), l.push("DTSTAMP:" + Y(r, "clean", !0)), l.push("DTSTART" + T + ":" + m.start), l.push("DTEND" + T + ":" + m.end), l.push("SUMMARY:" + H(t.dates[`${s}`].name, !0)), t.dates[`${s}`].descriptionHtmlFreeICal != null && t.dates[`${s}`].descriptionHtmlFreeICal != "" && l.push("DESCRIPTION:" + H(t.dates[`${s}`].descriptionHtmlFreeICal, !0)), t.dates[`${s}`].description != null && t.dates[`${s}`].description != "" && l.push(`X-ALT-DESC;FMTTYPE=text/html:\r
 <!DOCTYPE HTML PUBLIC ""-//W3C//DTD HTML 3.2//EN"">\r
 <HTML><BODY>\r
 ` + H(t.dates[`${s}`].description, !0) + `\r
 </BODY></HTML>`), t.dates[`${s}`].location != null && t.dates[`${s}`].location != "" && l.push("LOCATION:" + H(t.dates[`${s}`].location, !0)), t.dates[`${s}`].organizer != null && t.dates[`${s}`].organizer != "") {
      const v = t.dates[`${s}`].organizer.split("|");
      l.push('ORGANIZER;CN="' + H(v[0], !1, !0) + '":MAILTO:' + v[1]);
    }
    if (t.dates[`${s}`].attendee != null && t.dates[`${s}`].attendee != "") {
      const v = t.dates[`${s}`].attendee.split("|");
      l.push('ATTENDEE;ROLE=REQ-PARTICIPANT;CN="' + H(v[0], !1, !0) + '":MAILTO:' + v[1]);
    }
    if (t.recurrence != null && t.recurrence != "" && l.push(t.recurrence), t.dates[`${s}`].availability != null && t.dates[`${s}`].availability != "") {
      const v = function() {
        return t.dates[`${s}`].availability == "free" ? "TRANSPARENT" : "OPAQUE";
      }();
      l.push("TRANSP:" + v);
    }
    l.push("SEQUENCE:" + t.dates[`${s}`].sequence), l.push("STATUS:" + t.dates[`${s}`].status), l.push("CREATED:" + t.created), l.push("LAST-MODIFIED:" + t.updated), l.push("END:VEVENT");
  }
  l.push("END:VCALENDAR");
  const b = function() {
    return i != "" ? i : "data:text/calendar;charset=utf-8," + encodeURIComponent(l.join(`\r
`));
  }();
  if (C() && Ne() || de() && (C() || He() && Ve())) {
    Qt(e, b, t, n);
...
function jt(e, t) {
  ...
  if (e.icsFile != null && e.icsFile != "") {
    const n = e.icsFile.split("/").pop().split(".")[0];
    if (n != "")
      return n + a;
  }
...
function Qt(e, t, a, n) {
  if (ge(t), C() && Ne()) {
    Z(e, a, "warning", p("modal.crios.ical.h", a), p("modal.crios.ical.text", a) + "<br>" + p("modal.clipboard.text", a) + "<br>" + p("modal.crios.ical.steps", a), [], [], n);
    return;
  }
  Z(e, a, "warning", p("modal.webview.ical.h", a), p("modal.webview.ical.text", a) + "<br>" + p("modal.clipboard.text", a) + "<br>" + p("modal.webview.ical.steps", a), [], [], n);
}
function Gt(e, t) {
  z("success", t.identifier, t.identifier), t.proKey == null || t.proKey == "";
}
function _e(e, t) {
  try {
    const a = document.createElementNS("http://www.w3.org/1999/xhtml", "a");
    a.rel = "noopener", a.href = e, N() ? a.target = "_self" : a.target = "_blank", a.download = t + ".ics";
...
function L(e, t = "delimiters", a = "general", n = !1) {
  if (e.startTime != null && e.startTime != "" && e.endTime != null && e.endTime != "") {
    const o = /* @__PURE__ */ new Date(e.startDate + "T" + e.startTime + ":00.000+00:00"), i = /* @__PURE__ */ new Date(e.endDate + "T" + e.endTime + ":00.000+00:00"), r = i - o, l = Math.floor(r / 1e3 / 60 / 60), c = Math.floor((r - l * 60 * 60 * 1e3) / 1e3 / 60 % 60), d = function() {
      return l < 10 ? "0" + l + ":" + ("0" + c).slice(-2) : l + ":" + ("0" + c).slice(-2);
    }();
    if ((e.timeZone == null || e.timeZone != null && e.timeZone == "") && n)
      return {
    ...
    if (e.timeZone != null && e.timeZone != "") {
      ...
      const h = se(e.timeZone, e.startDate, e.startTime), b = se(e.timeZone, e.endDate, e.endTime);
      if (n) {
        const T = h.slice(0, 3) + ":" + h.slice(3), v = b.slice(0, 3) + ":" + b.slice(3);
        return {
          start: o.toISOString().replace(".000Z", T),
          end: i.toISOString().replace(".000Z", v),
          duration: d,
          allday: !1
        };
      }
      const s = parseInt(h[0] + 1) * -1 * ((parseInt(h.substring(1, 3)) * 60 + parseInt(h.substring(3, 5))) * 60 * 1e3), m = parseInt(b[0] + 1) * -1 * ((parseInt(b.substring(1, 3)) * 60 + parseInt(b.substring(3, 5))) * 60 * 1e3);
      o.setTime(o.getTime() + s), i.setTime(i.getTime() + m);
    }
    return {
      start: Y(o, t),
      end: Y(i, t),
    ...
    const o = e.startDate.split("-"), i = e.endDate.split("-"), r = new Date(Date.UTC(o[0], o[1] - 1, o[2], 12, 0, 0)), l = new Date(Date.UTC(i[0], i[1] - 1, i[2], 12, 0, 0));
    if ((a === "google" || a === "microsoft" && !N() || a === "msteams" || a === "ical") && l.setDate(l.getDate() + 1), a === "msteams") {
      if (N()) {
        const c = r.getTimezoneOffset(), d = function() {
          return c < 0 ? "+" + ("0" + Math.abs(c / 60)).slice(-2) + ":" + ("0" + Math.abs(c % 60)).slice(-2) : "-" + ("0" + Math.abs(c / 60)).slice(-2) + ":" + ("0" + Math.abs(c % 60)).slice(-2);
        }();
        return {
          start: Y(r, t, !1, !0) + "T00:00:00" + d,
          end: Y(l, t, !1, !0) + "T00:00:00" + d,
          allday: !0
        };
      }
      return {
        start: Y(r, t, !1, !0) + "+00:00",
        end: Y(l, t, !1, !0) + "+00:00",
        allday: !0
      };
    }
...
function Y(e, t = "delimiters", a = !0, n = !1) {
  const o = function() {
...
function F(e, t = !0) {
  const n = (t ? JSON.stringify(e) : e).replace(/(<(?!br)([^>]+)>)/gi, "");
  return t ? JSON.parse(n) : n;
}
function ae(e, t = !0) {
  return e.match(/((\.\.\/)|(\.\.\\)|(%2e%2e%2f)|(%252e%252e%252f)|(%2e%2e\/)|(%252e%252e\/)|(\.\.%2f)|(\.\.%252f)|(%2e%2e%5c)|(%252e%252e%255c)|(%2e%2e\\)|(%252e%252e\\)|(\.\.%5c)|(\.\.%255c)|(\.\.%c0%af)|(\.\.%25c0%25af)|(\.\.%c1%9c)|(\.\.%25c1%259c))/gi) ? (t && console.error("Seems like the generated URL includes at least one security issue and got blocked. Please check the calendar button parameters!"), !1) : !0;
}
function qe(e, t = !1) {
  return /^.{0,70}@.{1,30}\.[\w.]{2,9}$/.test(e) ? (t && console.log("Testing for MX records not yet available"), !0) : !1;
}
function B(e, t = !1, a = !1) {
  return t ? (e = e.replace(/\[(|\/)(url|hr|p|b|strong|u|i|em|li|ul|ol|h\d)\]|((\|.*)\[\/url\])/gi, ""), e = e.replace(/\{(|\/)(url|hr|p|b|strong|u|i|em|li|ul|ol|h\d)\}|((\|.*)\{\/url\})/gi, ""), a ? e = e.replace(/(\[br\]|\{br\})/gi, "\\n") : e = e.replace(/(\[br\]|\{br\})/gi, " "), e = e.replace(/&[#a-zA-Z0-9]{1,9};/gi, "")) : (e = e.replace(/\[(\/|)(br|hr|p|b|strong|u|i|em|li|ul|ol|h\d)\]/gi, "<$1$2>"), e = e.replace(/\{(\/|)(br|hr|p|b|strong|u|i|em|li|ul|ol|h\d)\}/gi, "<$1$2>"), e = e.replace(/\[url\]([\w&$+.,:;=~!*'?@^%#|\s\-()/]*)\[\/url\]/gi, function(n, o) {
    return Me(o);
...
function Me(e) {
  ...
  return '<a href="' + t[0] + '" target="' + xe + '" rel="noopener">' + a + "</a>";
}
function H(e, t = !0, a = !1) {
  return a ? e = e.replace(/"/g, "") : e = e.replace(/\\/g, "\\\\").replace(/(,|;)/g, "\\$1").replace(/\\\\n/g, "\\n"), t && (e = e.replace(/.{60}/g, `$&\r
 `)), e;
}
function De(e, t, a, n = !1, o = !1) {
  let i = !1;
  const r = t;
  t.querySelector(".atcb-dropdown-anchor") !== null && (t = t.querySelector(".atcb-dropdown-anchor"), i = !0), a.style.position = "relative", a.style.display = "inline-block";
  let l = t.getBoundingClientRect();
  const c = r.getBoundingClientRect(), d = r.parentNode.getBoundingClientRect(), h = document.documentElement.clientHeight;
  if (i === !0 && !a.classList.contains("atcb-dropoverlay")) {
    let s = a.getBoundingClientRect();
    a.style.width = s.width + "px", a.classList.contains("atcb-dropup") && o || !n && !o && l.top + s.height > h - 20 && 2 * c.top + c.height - l.top - s.height > 20 ? (r.classList.add("atcb-dropup"), a.classList.add("atcb-dropup"), a.style.bottom = d.bottom - c.bottom + (l.top - c.top) + "px") : (a.style.top = c.top - d.top + (l.top - c.top) + "px", r.classList.contains("atcb-dropup") && r.classList.remove("atcb-dropup")), l = t.getBoundingClientRect(), a.style.minWidth = l.width + "px", (a.classList.contains("atcb-dropdown") && !a.classList.contains("atcb-style-round") || a.classList.contains("atcb-style-text") || a.classList.contains("atcb-style-neumorphism")) && (a.style.maxWidth = l.width + "px"), s = a.getBoundingClientRect(), a.style.left = Math.round(l.left - d.left - (s.width - l.width) / 2) + "px";
  } else {
    a.style.minWidth = c.width + 20 + "px";
    const s = a.getBoundingClientRect();
    a.style.width = s.width + "px";
    const m = Math.round((c.width - s.width) / 4);
    a.style.margin = -Math.round((s.height + c.height) / 2) + "px " + m + "px 0 " + m + "px";
  }
  a.style.position = "absolute", a.style.display = "block";
  const b = e.querySelector("#add-to-calendar-button-reference");
  b && r.classList.contains("atcb-dropup") && (r.parentNode.parentNode.after(b), b.style.padding = "5px 15px", b.style.position = "absolute", b.style.left = c.left + "px");
}
function ve(e, t = null) {
  const a = function() {
    if (t != null)
      return t;
    {
      const o = e.querySelectorAll(".atcb-modal");
      return o.length == 0 ? null : o[o.length - 1];
    }
  }();
  if (a == null)
    return;
  a.getBoundingClientRect().height + 100 > window.innerHeight ? (document.body.classList.add("atcb-modal-no-scroll"), document.documentElement.classList.add("atcb-modal-no-scroll")) : (document.body.classList.remove("atcb-modal-no-scroll"), document.documentElement.classList.remove("atcb-modal-no-scroll"));
}
function X(e) {
...
function ge(e) {
  ...
  const a = t.contentEditable, n = t.readOnly;
  if (t.contentEditable = !0, t.readOnly = !1, t.value = e, C()) {
    var o = document.createRange();
    o.selectNodeContents(t);
    var i = window.getSelection();
    i.removeAllRanges(), i.addRange(o), t.setSelectionRange(0, 999999);
  } else
    t.select();
...
function R(e, t = 300) {
  let a;
  return (...n) => {
    a || e.apply(this, n), clearTimeout(a), a = setTimeout(() => {
      a = void 0;
    }, t);
  };
}
function z(e, t, a) {
  ...
  n && n.setAttribute("atcb-last-event", e + ":" + t), M() && Kt(e, t);
}
function Kt(e, t) {
  let a = "";
  switch (e) {
...
function p(e, t) {
  return t.customLabels != null && t.customLabels[`${e}`] != null && t.customLabels[`${e}`] != "" ? B(t.customLabels[`${e}`]) : Jt(e, t.language);
}
function Jt(e, t) {
  return t || (t = "en"), he[`${t}`][`${e}`] ? he[`${t}`][`${e}`] : e;
}
let fe = !1, K = 0;
const q = [], Re = '<div class="atcb-initialized" style="display:none;position:relative;width:fit-content;"></div>';
if (M()) {
  class e extends HTMLElement {
    constructor() {
      super();
      const a = document.createElement("template");
      a.innerHTML = Re, this.attachShadow({ mode: "open", delegateFocus: !0 }), this.shadowRoot.append(a.content.cloneNode(!0)), this.loaded = !1, this.initialized = !1, this.data = {}, this.error = !1;
    }
    async connectedCallback() {
      if (this.debug = this.hasAttribute("debug"), this.getAttribute("proKey") != null && this.getAttribute("proKey") != "" && (this.data = aa(this.getAttribute("proKey"))), this.data.name == null || this.data.name == "") {
        try {
          this.data = Ce(this), this.loaded = !0;
        } catch (a) {
          this.debug && ce(this.shadowRoot, a), this.loaded = !0;
          return;
        }
        this.data.proKey = "";
      }
    ...
    disconnectedCallback() {
      Be(this.shadowRoot, this.data), this.debug && console.log('Add to Calendar Button "' + this.data.identifier + '" destroyed'), document.querySelectorAll("add-to-calendar-button").length == 0 && (K = 0);
    }
    static get observedAttributes() {
      const a = ["instance"];
      return be.map((n) => n.toLowerCase()).concat(a);
    }
    attributeChangedCallback(a, n, o) {
      if (this.data.proKey != null && this.data.proKey != "" || !this.loaded)
        return;
      this.debug && this.initialized && console.log(`${a}'s value has been changed from ${n} to ${o}`), Be(this.shadowRoot, this.data), this.data = {}, this.shadowRoot.querySelector(".atcb-initialized").remove();
      const i = document.createElement("template");
      i.innerHTML = Re, this.shadowRoot.append(i.content.cloneNode(!0));
      try {
        this.data = Ce(this);
      } catch (r) {
        this.debug && ce(this.shadowRoot, r);
        return;
      }
      this.initButton();
    }
    initButton() {
      this.initialized || (this.initialized = !0, K = K + 1), this.identifier && this.identifier != "" ? this.data.identifier = this.identifier : (this.data.identifier && this.data.identifier != "" && (/^[\w\-_]+$/.test(this.data.identifier) ? this.data.identifier = "atcb-btn-" + this.data.identifier : (this.data.identifier = "", this.debug && console.warn("Add to Calendar Button generation: identifier invalid - using auto numbers instead"))), (this.data.identifier == null || this.data.identifier == "") && (this.data.identifier = "atcb-btn-" + K), this.identifier = this.data.identifier), this.setAttribute("atcb-button-id", this.data.identifier);
      try {
        Xt(this.shadowRoot, this.data, this.debug);
      } catch (a) {
        this.debug && ce(this.shadowRoot, a);
        return;
      }
    }
  }
...
function Ce(e) {
  ...
  for (let a = 0; a < be.length; a++) {
    let n = be[`${a}`];
    if (e.hasAttribute(`${n}`)) {
      let i = F(e.getAttribute(`${n}`).replace(/(\\r\\n|\\n|\\r)/g, ""), !1), r;
      if (ue.includes(n))
        i == "" ? r = !0 : r = i === "true";
        ...
        const l = function() {
          return i.substring(0, 1) != "[" ? "[" + i + "]" : i;
        }();
        r = JSON.parse(l);
      } else if (nt.includes(n)) {
        const l = function() {
          let c = i;
          return (i.includes('"') || i.includes("'")) && (i.includes("[") ? c = i.substring(2, i.length - 2) : c = i.substring(1, i.length - 1)), i.includes("|") || (c = c.replace(/\s/g, "")), c;
        }();
        l.includes("','") ? r = l.split("','") : r = l.split('","');
      } else
        r = i;
      t[`${n}`] = r;
    }
    const o = e.getAttribute("identifier");
    o != null && o != "" && (t.identifier = F(o.replace(/(\\r\\n|\\n|\\r)/g, ""), !1));
  }
  if (!ft(t)) {
    const a = e.innerHTML, n = function() {
      if (a != "")
        try {
          return JSON.parse(F(a.replace(/(\\r\\n|\\n|\\r)/g, ""), !1));
        } catch (o) {
          throw new Error(`Add to Calendar Button generation failed: JSON content provided, but badly formatted (in doubt, try some tool like https://jsonformatter.org/ to validate).\r
Error message: ` + o);
        }
      return "";
    }();
    if (n.length == 0)
      throw console.error(t.validationError), new Error("Add to Calendar Button generation failed: no data provided or missing required fields - see console logs for details");
    t = n;
  }
  return t;
}
function Xt(e, t, a = !1) {
  if (t = ot(t), xt(t)) {
    const n = e.querySelector(".atcb-initialized");
    ke(e, t), n.setAttribute("lang", t.language), Qe(e, n, t.buttonStyle, t.inline, t.buttonsList, t.customCss), ea(t), na(e, t), ta(t.proKey, a), t.hidden || ($t(e, n, t, a), !t.hideRichData && t.name && t.dates[0].location && t.dates[0].startDate && (Ot(t, e.host), t.schemaEl = e.host.previousSibling)), z("initialization", t.identifier, t.identifier);
  } else if (a)
    throw console.error(t.validationError), new Error(t.validationError);
}
function Be(e, t) {
  V(e), la(t.identifier), t.schemaEl != null && t.schemaEl.remove(), Array.from(e.querySelectorAll(".atcb-debug-error-msg")).concat(Array.from(e.querySelectorAll("style"))).concat(Array.from(e.querySelectorAll(".atcb-button-wrapper"))).forEach((a) => a.remove()), delete k[`${t.identifier}`];
}
function ke(e, t) {
  e.host.classList.remove("atcb-dark", "atcb-light", "atcb-bodyScheme");
  const a = function() {
    return t.lightMode == "bodyScheme" ? document.body.classList.contains("atcb-dark") || document.documentElement.classList.contains("atcb-dark") ? "dark" : "light" : t.lightMode;
  }();
  e.host.classList.add("atcb-" + a);
}
function Qe(e, t = null, a = "", n = !1, o = !1, i = "") {
  if (!document.getElementById("atcb-global-style")) {
    ...
    r.innerText = ".atcb-modal-no-scroll { overflow-y: hidden !important; -webkit-overflow-scrolling: touch; } body.atcb-modal-no-scroll { padding-right: " + l + "px; }", document.head.append(r);
  }
  if (i != "" && a == "custom") {
    const r = document.createElement("link");
    if (r.setAttribute("rel", "stylesheet"), r.setAttribute("type", "text/css"), r.setAttribute("href", i), t == null)
      e.host.style.display = "none", $e(r, e, e.host);
    else {
      const l = document.createElement("div");
      l.style.cssText = "width: 150px; height: 40px; border-radius: 200px; background-color: #777; opacity: .3;", e.prepend(l), $e(r, e, t, l, n, o);
    }
    return;
  }
  if (a != "none" && we[`${a}`] != null) {
    const r = document.createElement("style"), l = function() {
      return e.host.hasAttribute("styleLight") ? ":host { " + F(e.host.getAttribute("styleLight").replace(/(\\r\\n|\\n|\\r)/g, ""), !1) + " }" : "";
    }(), c = function() {
      return e.host.hasAttribute("styleDark") ? ":host(.atcb-dark), :host-context(html.atcb-dark):host(.atcb-bodyScheme), :host-context(body.atcb-dark):host(.atcb-bodyScheme) { " + F(e.host.getAttribute("styleDark").replace(/(\\r\\n|\\n|\\r)/g, ""), !1) + " }" : "";
    }();
    r.innerText = we[`${a}`] + l + c, e.prepend(r);
  }
  t != null && (n ? t.style.display = "inline-block" : o ? (t.style.display = "flex", t.style.flexWrap = "wrap", t.style.justifyContent = "center") : t.style.display = "block");
}
async function $e(e, t, a, n = null, o = !1, i = !1) {
  t.prepend(e), await new Promise((r) => {
    e.onload = r;
  }), n != null && n.remove(), o ? a.style.display = "inline-block" : i ? (a.style.display = "flex", a.style.flexWrap = "wrap", a.style.justifyContent = "center") : a.style.display = "block";
}
function ce(e, t) {
  if (e.querySelector(".atcb-debug-error-msg"))
    return;
  const a = document.createElement("div");
  a.classList.add("atcb-debug-error-msg"), a.style.cssText = "color: #bf2e2e; font-size: 12px; font-weight: bold; padding: 12px 15px; border: 2px solid #bf2e2e; max-width: 180px; border-radius: 13px;", a.textContent = t, e.append(a);
}
function ea(e) {
  const t = [];
  for (let a = 0; a < e.options.length; a++) {
    t[e.options[`${a}`]] = [];
    for (let n = 1; n <= e.dates.length; n++)
...
`, "font-weight: bold;"), fe = !0;
  }
}
function aa(e) {
  const t = {};
  return e != null && e != "" && (t.proKey = e, t.identifier = e, console.error("Add to Calendar Button proKey invalid! Falling back to local data...")), t;
}
function na(e, t) {
  M() && (t.lightMode == "bodyScheme" && (q[t.identifier] = new MutationObserver(function(a) {
    a.forEach((n) => {
      n.attributeName === "class" && ke(e, t);
    });
  }), q[t.identifier].observe(document.documentElement, { attributes: !0 }), q[t.identifier].observe(document.body, { attributes: !0 })), fe || (document.addEventListener("keyup", oa), document.addEventListener("keydown", ia), window.addEventListener("resize", ra)));
}
function oa(e) {
  const t = function() {
    const a = document.querySelector('[atcb-button-id="' + k.active + '"]');
    return a ? a.shadowRoot : null;
  }();
  t && e.key === "Escape" && (z("closeList", "Ecs Hit", k.active), A(t, "close", "", "", !0));
}
function ia(e) {
  const t = function() {
    const a = document.querySelector('[atcb-button-id="' + k.active + '"]'), n = document.getElementById(k.active + "-modal-host");
    return n ? n.shadowRoot : a ? a.shadowRoot : null;
  }();
  if (t && t.querySelector(".atcb-list") && (e.key === "ArrowDown" || e.key === "ArrowUp" || e.key === "Tab")) {
    e.preventDefault();
    let a = 0, n = t.activeElement;
    const o = t.querySelectorAll(".atcb-list-item").length;
    if (n && n.classList.contains("atcb-list-item"))
      e.key === "ArrowDown" && n.dataset.optionNumber < o ? a = parseInt(n.dataset.optionNumber) + 1 : e.key === "Tab" ? n.dataset.optionNumber < o ? a = parseInt(n.dataset.optionNumber) + 1 : a = 1 : e.key === "ArrowUp" && n.dataset.optionNumber >= 1 && (a = parseInt(n.dataset.optionNumber) - 1), a > 0 && t.querySelector('.atcb-list-item[data-option-number="' + a + '"]').focus();
    else
      switch (e.key) {
        default:
...
function ra() {
  const e = function() {
    const t = document.querySelector('[atcb-button-id="' + k.active + '"]'), a = document.getElementById(k.active + "-modal-host");
...
const sa = (e) => {
  const t = ye.useMemo(() => {
    ...
    for (const [n, o] of Object.entries(e)) {
      let i = o;
      typeof o != "string" && typeof o != "boolean" && (i = JSON.stringify(o)), Object.assign(a, { [n]: i });
    }
    return a;
  }, [e]);
  return /* @__PURE__ */ ye.createElement("add-to-calendar-button", { ...t });
};
export {
  sa as AddToCalendarButton
};
